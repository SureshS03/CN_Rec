 ...
 public static void findMAC(String ip) throws
 Exception{ File fp=new File("ARPTable.txt");
...
break;
 ...
 System.out.println("This program is done by SURESH S 221211101143"); getARPTable(Command);
